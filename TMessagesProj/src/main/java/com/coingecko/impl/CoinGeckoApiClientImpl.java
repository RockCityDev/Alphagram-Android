...
import com.coingecko.CoinGeckoApi;
import com.coingecko.CoinGeckoApiClient;
import com.coingecko.CoinGeckoApiService;
...
public class CoinGeckoApiClientImpl implements CoinGeckoApiClient {
    ...
    public CoinFullData getCoinById(String id) {
        return getCoinById(id, false, false, true, false, false, false);
    }
