...
public abstract class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (divider.getLeftSideLine().isHave()) {
                int lineWidthPx = SizeUtils.dp2px(divider.getLeftSideLine().getWidthDp());
                int startPaddingPx = SizeUtils.dp2px(divider.getLeftSideLine().getStartPaddingDp());
                int endPaddingPx = SizeUtils.dp2px(divider.getLeftSideLine().getEndPaddingDp());
            ...
            if (divider.getTopSideLine().isHave()) {
                int lineWidthPx = SizeUtils.dp2px(divider.getTopSideLine().getWidthDp());
                int startPaddingPx = SizeUtils.dp2px(divider.getTopSideLine().getStartPaddingDp());
                int endPaddingPx = SizeUtils.dp2px(divider.getTopSideLine().getEndPaddingDp());
            ...
            if (divider.getRightSideLine().isHave()) {
                int lineWidthPx = SizeUtils.dp2px(divider.getRightSideLine().getWidthDp());
                int startPaddingPx = SizeUtils.dp2px(divider.getRightSideLine().getStartPaddingDp());
                int endPaddingPx = SizeUtils.dp2px(divider.getRightSideLine().getEndPaddingDp());
            ...
            if (divider.getBottomSideLine().isHave()) {
                int lineWidthPx = SizeUtils.dp2px(divider.getBottomSideLine().getWidthDp());
                int startPaddingPx = SizeUtils.dp2px(divider.getBottomSideLine().getStartPaddingDp());
                int endPaddingPx = SizeUtils.dp2px(divider.getBottomSideLine().getEndPaddingDp());
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        Y_Divider divider = getDivider(itemPosition);
        int left = divider.getLeftSideLine().isHave() ? SizeUtils.dp2px(divider.getLeftSideLine().getWidthDp()) : 0;
        int top = divider.getTopSideLine().isHave() ? SizeUtils.dp2px(divider.getTopSideLine().getWidthDp()) : 0;
        int right = divider.getRightSideLine().isHave() ? SizeUtils.dp2px(divider.getRightSideLine().getWidthDp()) : 0;
        int bottom = divider.getBottomSideLine().isHave() ? SizeUtils.dp2px(divider.getBottomSideLine().getWidthDp()) : 0;
