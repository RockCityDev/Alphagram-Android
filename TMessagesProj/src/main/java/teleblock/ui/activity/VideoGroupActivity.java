...
import teleblock.ui.adapter.VideoGroupRvAdapter;
...
import teleblock.video.KKVideoLoadListener;
import teleblock.video.KKVideoMessage;
...
//        videoRvAdapter.getLoadMoreModule().setLoadMoreView(new NSLoadMoreView());
    ...
    private List<KKVideoMessage> dealMessageDate(List<KKVideoMessage> videoMessages) {
        ...
        SimpleDateFormat formatter = new SimpleDateFormat(LocaleController.getString("dateformat", R.string.dateformat));
        for (KKVideoMessage kkVideoMessage : videoMessages) {
