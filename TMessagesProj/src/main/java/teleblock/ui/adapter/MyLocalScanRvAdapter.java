 ...
 * 首页已完成视频列表
 */
public class MyLocalScanRvAdapter extends BaseDelegateMultiAdapter<LocalVideoEntity, BaseViewHolder> implements LoadMoreModule {
    Context context;
    boolean edit;

    public MyLocalScanRvAdapter(Context context) {
    ...
    private void showItem(BaseViewHolder baseViewHolder, LocalVideoEntity entity) {
        ShapeableImageView imageView = baseViewHolder.findView(R.id.iv_cover);
