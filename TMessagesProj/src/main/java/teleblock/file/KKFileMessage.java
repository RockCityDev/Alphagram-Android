 ...
 * 文件消息封装类
 */
public class KKFileMessage extends BaseModel {
    ...
    public String getFromName() {
        return getFromName(this.messageObject);
    }

    public static String getFromName(MessageObject messageObject) {
    ...
    public KKFileDownloadStatus getDownloadStatus() {
        if (downloadStatus == null) {
            downloadStatus = new KKFileDownloadStatus();
        }
