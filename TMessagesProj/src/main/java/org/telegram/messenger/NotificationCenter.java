...
public class NotificationCenter {
    ...
    // 自定义START
    public static final int loadGifStickerData = totalEvents++;
    public static final int chatListNeedReload = totalEvents++;
    public static final int didApplyVideoWallpaper = totalEvents++;
    // 自定义END
