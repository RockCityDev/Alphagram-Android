...
public class ReactionsContainerLayout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    // 自定义START
    private boolean closeLongClick = false;
    private boolean layoutDirection = LocaleController.isRTL;
    // 自定义END
...
//        }
        ...
        int s = canvas.save();
        float pivotX = layoutDirection ? getWidth() * 0.125f : getWidth() * 0.875f;
        ...
        canvas.translate((layoutDirection ? -1 : 1) * getWidth() * (1f - transitionProgress), 0);
    ...
    private void drawBubbles(Canvas canvas, float br, float cPr, float sr, int alpha) {
        ...
        float cx = layoutDirection ? bigCircleOffset : getWidth() - bigCircleOffset;
        ...
        cx = layoutDirection ? bigCircleOffset - bigCircleRadius : getWidth() - bigCircleOffset + bigCircleRadius;
    ...
    /*拓展方法*/
    public void setCloseLongClick(boolean ifClose) {
        closeLongClick = ifClose;
    }
