...
public class ActionBarMenu extends LinearLayout {
    ...
    public ActionBarMenuItem addItem(int id, Drawable drawable,int iconColor) {
        return addItem(id, 0, null, isActionMode ? parentActionBar.itemsActionModeBackgroundColor : parentActionBar.itemsBackgroundColor, iconColor, drawable, AndroidUtilities.dp(48), null, null);
    }
    ...
    public ActionBarMenuItem addItem(int id, int icon, CharSequence text, int backgroundColor, Drawable drawable, int width, CharSequence title, Theme.ResourcesProvider resourcesProvider) {
        return addItem(id, icon, text, backgroundColor, isActionMode ? parentActionBar.itemsActionModeColor : parentActionBar.itemsColor, drawable, width, title, resourcesProvider);
    }

    public ActionBarMenuItem addItem(int id, int icon, CharSequence text, int backgroundColor, int iconColor,Drawable drawable, int width, CharSequence title, Theme.ResourcesProvider resourcesProvider) {
        ActionBarMenuItem menuItem = new ActionBarMenuItem(getContext(), this, backgroundColor, iconColor, text != null, resourcesProvider);
        menuItem.setTag(id);
        if (text != null) {
