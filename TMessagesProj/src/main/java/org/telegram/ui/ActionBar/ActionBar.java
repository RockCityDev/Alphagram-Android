...
public class ActionBar extends FrameLayout {
    ...
    private Drawable lastLeftDrawable;
    // 自定义END
    ...
    public void setBackButtonDrawable(Drawable drawable) {
        ...
        if (drawable instanceof BackDrawable) {
            ...
            backButtonImageView.clearColorFilter();
        }
    }
    ...
    protected boolean shouldClipChild(View child) {
        return clipContent && (child == titleTextView[0] || child == titleTextView[1] || child == subtitleTextView || child == menu || child == backButtonImageView || child == additionalSubtitleTextView || child==extraView);
    }
    ...
    public void setTitle(CharSequence value, Drawable leftDrawable, Drawable rightDrawable) {
        ...
        if (titleTextView[0] != null) {
            ...
            titleTextView[0].setLeftDrawable(lastLeftDrawable = leftDrawable);
...
//        }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (extraView != null) {
            int t = additionalTop + getCurrentActionBarHeight();
            extraView.layout(0, t, extraView.getMeasuredWidth(), t + extraView.getMeasuredHeight());
        }
        ...
        for (int i = 0; i < childCount; i++) {
            View child = getChildAt(i);
            if (child.getVisibility() == GONE || child == titleTextView[0] || child == titleTextView[1] || child == subtitleTextView || child == menu || child == backButtonImageView || child == additionalSubtitleTextView || child==extraView || child == avatarSearchImageView) {
                continue;
            }
    ...
    public void setTitleOverlayText(String title, int titleId, Runnable action) {
        ...
        Drawable leftDrawableToSet = title != null ? null : lastLeftDrawable;
        ...
        if ((textToSet != null && titleTextView[0] == null) || getMeasuredWidth() == 0 || (titleTextView[0] != null && titleTextView[0].getVisibility() != View.VISIBLE)) {
            ...
            titleTextView[0].setLeftDrawable(leftDrawableToSet);
            ...
            titleTextView[1].setLeftDrawable(leftDrawableToSet);
