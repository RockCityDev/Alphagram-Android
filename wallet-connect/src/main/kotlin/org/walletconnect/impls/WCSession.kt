...
class WCSession(
    ...
    // Non-persisted state
    private val transport = config.bridge?.let { transportBuilder.build(it, ::handleStatus, ::handleMessage) }
...
//                throw IllegalArgumentException("Provided clientId is different from stored clientId")
    ...
    fun createCallId() = System.currentTimeMillis() * 1000 + Random().nextInt(999)
